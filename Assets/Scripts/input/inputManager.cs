...
public partial class @InputManager: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Camera"",
            ""id"": ""2ca96de0-930a-4294-8d84-952326cb7f85"",
            ""actions"": [
                {
                    ""name"": ""MouseClick"",
                    ""type"": ""Button"",
                    ""id"": ""b8a3742b-3cde-4af4-a073-7484a429c3e2"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""2afab333-881d-4975-b612-07acf5182804"",
    ...
    ~@InputManager()
    {
        UnityEngine.Debug.Assert(!m_Camera.enabled, "This will cause a leak and performance issues, InputManager.Camera.Disable() has not been called.");
    }
